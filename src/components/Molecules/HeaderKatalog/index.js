    ...
    return (
        <View style={{backgroundColor:'lavender',height:200}}> 
            <View style={{marginHorizontal:15,flexDirection:'row', paddingTop:15}}>
                ...
                <TextInput placeholder="test" style={{borderWidth:1, borderColor:'red',borderRadius:10,height:40,fontSize:13, paddingLeft:20,paddingRight:40, marginRight: 10 ,backgroundColor:'white'}}/>
